...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-5(4ue&=(%4b8!qvpq62wezr=y4f81y1mlk*6*v+0y#ohw!pi75')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True  # For production

ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'epoxy.pythonanywhere.com']
...
EMAIL_HOST_USER = 'fwoonder89@gmail.com'  # Your email address
EMAIL_HOST_PASSWORD = 'yjqm ombi mfeq oxrp'  # App password
DEFAULT_FROM_EMAIL = 'Lenox <fwoonder89@gmail.com>'
